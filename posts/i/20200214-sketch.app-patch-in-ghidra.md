...
![Show Reference To](https://duraki.github.io/images/posts/ghidra-lm-methodlist-references)
...
At the address `0x1004a1738`, is instruction JNZ (Jump not equal), which calls code signature method and exit the Sketch. Just replace this jump to the next instruction at `0x1004a173e`. 
...
![Create Certificate in Keychain Access](https://duraki.github.io/images/posts/create-certficiate.png)
